 ...
 */
 ...
 #define BIND_del_curterm_FUNCTION FALSE
 ...
 #define BIND_putp_FUNCTION FALSE
 ...
 #define BIND_set_curterm_FUNCTION FALSE
 ...
 #define BIND_tgetent_FUNCTION FALSE
 #define BIND_tgetflag_FUNCTION FALSE
 #define BIND_tgetnum_FUNCTION FALSE
 #define BIND_tgetstr_FUNCTION FALSE
 #define BIND_tgoto_FUNCTION FALSE
 #define BIND_tigetflag_FUNCTION FALSE
 #define BIND_tigetnum_FUNCTION FALSE
 #define BIND_tigetstr_FUNCTION FALSE
 ...
 #define BIND_tparm_FUNCTION FALSE
 ...
 #define BIND_vidattr_FUNCTION FALSE
